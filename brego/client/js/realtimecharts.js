/* License: MIT
 * Modified from https://gist.github.com/pjsier/fbf9317b31f070fd540c5523fef167ac
 */


function realTimeLineChart(ymin, ymax, keys) {
  ...
  function chart(selection) {
    ...
    selection.each(function(data) {
      ...
      var legendEnter = gEnter.append("g")
        .attr("class", "legend")
        .attr("transform", "translate(" + (width-margin.right-margin.left-300) + ",-25)");
